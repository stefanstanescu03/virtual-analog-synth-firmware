...
void draw_line_p_p(int16_t x0, int16_t y0, int16_t x1, int16_t y1, struct ssd1306_t* display);
...
void draw_char(int16_t x, int16_t y, char c, uint16_t fost_size, struct ssd1306_t *display);
void write_string(int16_t x, int16_t y, char* str, uint16_t fost_size, struct ssd1306_t *display);
